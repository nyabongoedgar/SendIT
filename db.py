...
class DatabaseConnection:
    ...
    def __init__(self):
        ...
        try:
            self.connection = psycopg2.connect(db=db_name,user='fvheujobpptfos', host='ec2-23-21-201-12.compute-1.amazonaws.com',password='5b404bb6671defebfed8c63f4df98f14594660f26675b1c225ddc97b51c5cee3',port='5432')
